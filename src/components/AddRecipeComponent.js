...
import { View, Text, Image,ScrollView, StyleSheet, TouchableOpacity, TextInput, AsyncStorage } from 'react-native'
...
export default class AppRecipeComponent extends React.Component {
    ...
    async componentDidMount() {
        ...
        this.arr = JSON.parse(await AsyncStorage.getItem(categoryName)) || dataDefault
        ...
        return (
            <ScrollView >
                ...
                <TextInput
                    ...
                    style={{ height: 100, backgroundColor: 'azure', fontSize: 16, marginTop: 10 }}
                />
                ...
                <TouchableOpacity
                    ...
                    style={{ paddingHorizontal: 10, backgroundColor: 'green', alignItems: 'center', marginTop: 20, marginBottom: 20 }}>
